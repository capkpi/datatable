...
const devCjs = merge(baseJS, {
    output: {
        file: 'dist/capkpi-datatable.cjs.js',
        format: 'cjs'
    }
});
...
const devCSS = merge(baseCSS, {
    output: {
        file: 'dist/capkpi-datatable.css',
        format: 'cjs'
    }
});
...
const prodIIFE = merge(devIIFE, {
    output: {
        file: 'dist/capkpi-datatable.min.js'
    },
    plugins: [
        uglify()
    ]
...
const prodCSS = merge(devCSS, {
    output: {
        file: 'dist/capkpi-datatable.min.css'
    }
});
